...
public class AvailableOpeningResponse {
    ...
    public AvailableOpeningResponse() {}

    public AvailableOpeningResponse(Long openingId, Long courseId, String courseName, Integer credit,
